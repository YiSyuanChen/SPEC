...
META_MODEL_FOLDER="../results/spec_meta/train/full_model_with_full_dec_sw_ada/xlsum_cond_own_xsum_cond_own_reddit_tifu_unsup_own_eval_reddit_tifu_cond_own_anil/checkpoint-9500"
