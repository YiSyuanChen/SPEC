...
INTER_MODEL_FOLDER="../results/unsupervision/train/full_model/amazon_reviews_multi_unsup_own_eval_amazon_reviews_multi/checkpoint-5000"
...
INTER_MODEL_FOLDER="../results/unsupervision/train/full_model/scitldr_unsup_own_eval_scitldr/checkpoint-600"
...
INTER_MODEL_FOLDER="../results/unsupervision/train/full_model/samsum_unsup_own_eval_samsum/checkpoint-300"
...
INTER_MODEL_FOLDER="../results/unsupervision/train/full_model/rottentomatoes_unsup_own_eval_rottentomatoes_own/checkpoint-100"
