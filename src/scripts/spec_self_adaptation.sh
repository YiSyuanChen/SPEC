...
##### Manual Settings #####
INTER_DATASET="newsroom_unsup_own"
INTER_MODEL_FOLDER="../results/spec_self/train/full_model_with_full_dec_ada/newsroom_unsup_own_eval_newsroom_cond_own/checkpoint-16000"
TRAIN_EVAL_DATASET="newsroom_cond_own"
...
OUTPUT_FOLDER="../results/try/spec_self/adaptation/${TRAIN_PARAMS_CONFIG}"
